...
import { detectLanguage, getLanguagePromptInstruction, type DetectedLanguage } from "../utils/language-detection";
...
export async function generateFinalAdvice(
  ...
  const systemPrompt = `You are IRAIVI, a financial assistant designed to help users with simple financial advice.
