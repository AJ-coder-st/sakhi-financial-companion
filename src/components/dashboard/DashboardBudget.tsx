  ...
  <div className="max-w-3xl mx-auto space-y-6">
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-sm text-muted-foreground">March 2026 — ₹8,600 spent of ₹12,000 income</p>
      </div>
    ...
    <div className="bg-muted rounded-2xl p-4 flex items-center gap-3">
      ...
      <div>
        <p className="text-sm font-medium">Voice Log Expenses</p>
        <p className="text-xs text-muted-foreground">Say "Maine 50 rupaye sabzi pe kharch kiye" to log instantly</p>
      </div>
    </div>
